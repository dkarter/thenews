...
/***/ function(module, exports) {
	...
	var _mthadley$thenews$ItemEntry$view = F2(
		function (showText, item) {
			var textContent = showText ? _mthadley$thenews$Util$viewHtmlContent(item.text) : _mthadley$thenews$Util$empty;
			return A2(
	...
	var _mthadley$thenews$CategoryPage$view = function (items) {
		var _p0 = items;
		switch (_p0.ctor) {
			case 'Done':
				return A2(
					...
					{ctor: '[]'},
					A2(_elm_lang$core$List$indexedMap, _mthadley$thenews$CategoryPage$viewCategoryItem, _p0._0));
			case 'Loading':
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('HN!'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
	...
	var _mthadley$thenews$ItemPage$defaultId = function (_p0) {
		return A2(
	...
	var _mthadley$thenews$ItemPage$RecieveComments = F2(
		function (a, b) {
			return {ctor: 'RecieveComments', _0: a, _1: b};
		});
	var _mthadley$thenews$ItemPage$fetchComments = F2(
		function (count, item) {
			return A2(
				_mthadley$thenews$Api$send,
				_mthadley$thenews$ItemPage$RecieveComments(item.id),
	...
	var _mthadley$thenews$ItemPage$RecieveItem = function (a) {
		return {ctor: 'RecieveItem', _0: a};
	};
	var _mthadley$thenews$ItemPage$fetchItem = function (_p4) {
		return A2(
			_mthadley$thenews$Api$send,
			_mthadley$thenews$ItemPage$RecieveItem,
		...
		function (msg, model) {
			...
			switch (_p7.ctor) {
				case 'FetchComments':
					...
					return _elm_lang$core$Native_Utils.eq(
						_p8,
						_mthadley$thenews$ItemPage$defaultId(model.item)) ? _mthadley$thenews$ItemPage$fetchItemComment(model) : A2(_mthadley$thenews$ItemPage$fetchNestedComment, _p8, model);
				case 'RecieveItem':
					var _p9 = _p7._0;
					var cmd = A2(
				...
				case 'RecieveComments':
					...
					var delta = _elm_lang$core$Native_Utils.eq(
						_p10,
						_mthadley$thenews$ItemPage$defaultId(model.item)) ? _mthadley$thenews$ItemPage$pageSize : 0;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
				...
				default:
					...
					if (_p11.ctor === 'ViewItem') {
						...
						return (_mthadley$thenews$RemoteData$isDone(model.item) && _elm_lang$core$Native_Utils.eq(
							_p12,
							_mthadley$thenews$ItemPage$defaultId(model.item))) ? A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model,
							{ctor: '[]'}) : {
							ctor: '_Tuple2',
		...
		function (comments, _p13) {
			...
			return A2(
				...
				},
				{
					...
					_1: {
						ctor: '::',
						_0: _mthadley$thenews$Util$viewHtmlContent(_p15.text),
						_1: {
							ctor: '::',
							_0: A2(
	...
	var _mthadley$thenews$App$getData = function (category) {
		return function (_p0) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
	...
	var _mthadley$thenews$App$insertItems = function (category) {
		return _elm_lang$core$Dict$insert(
			_mthadley$thenews$Api$stringId(category));
	};
	var _mthadley$thenews$App$Model = F3(
		function (a, b, c) {
			return {currentRoute: a, items: b, itemPage: c};
		});
	...
	var _mthadley$thenews$App$viewMain = function (model) {
		var content = function () {
			var _p1 = model.currentRoute;
			switch (_p1.ctor) {
				case 'NotFound':
					return _mthadley$thenews$NotFoundPage$view;
				case 'View':
					return _mthadley$thenews$CategoryPage$view(
						A2(_mthadley$thenews$App$getData, _p1._0, model.items));
				default:
					return A2(
	...
	var _mthadley$thenews$App$RecieveItems = F2(
		function (a, b) {
			return {ctor: 'RecieveItems', _0: a, _1: b};
		});
	var _mthadley$thenews$App$fetchItems = function (category) {
		return function (_p2) {
			return A2(
				_mthadley$thenews$Api$send,
				_mthadley$thenews$App$RecieveItems(category),
				_mthadley$thenews$Api$requestCategory(_p2));
		}(category);
	};
	var _mthadley$thenews$App$updateRoute = F2(
		function (items, route) {
			var _p3 = route;
			if (_p3.ctor === 'View') {
				var _p4 = _p3._0;
				return _mthadley$thenews$RemoteData$isDone(
					A2(_mthadley$thenews$App$getData, _p4, items)) ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					items,
					{ctor: '[]'}) : {
					ctor: '_Tuple2',
					_0: A3(_mthadley$thenews$App$insertItems, _p4, _mthadley$thenews$RemoteData$Loading, items),
					_1: _mthadley$thenews$App$fetchItems(_p4)
				};
			} else {
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
	...
	var _mthadley$thenews$App$init = function (location) {
		...
		var _p5 = A2(_mthadley$thenews$App$updateRoute, _elm_lang$core$Dict$empty, route);
		var items = _p5._0;
		var cmd = _p5._1;
		var _p6 = _mthadley$thenews$ItemPage$init(route);
		var itemPage = _p6._0;
		var itemPageCmd = _p6._1;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			{currentRoute: route, items: items, itemPage: itemPage},
			{
				ctor: '::',
				_0: cmd,
				_1: {
	...
	var _mthadley$thenews$App$update = F2(
		function (msg, model) {
			...
			switch (_p7.ctor) {
				case 'RecieveItems':
					var newItems = A3(
						_mthadley$thenews$App$insertItems,
						_p7._0,
						_mthadley$thenews$RemoteData$fromResult(_p7._1),
						model.items);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
				...
				case 'RouteChange':
					...
					var _p8 = A2(
						...
						_mthadley$thenews$ItemPage$RouteChange(_p10),
						model.itemPage);
					var itemPage = _p8._0;
					var itemPageCmd = _p8._1;
					var _p9 = A2(_mthadley$thenews$App$updateRoute, model.items, _p10);
					var newItems = _p9._0;
					var cmd = _p9._1;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{currentRoute: _p10, items: newItems, itemPage: itemPage}),
						{
							ctor: '::',
							_0: cmd,
							_1: {
				...
				default:
					var _p11 = A2(_mthadley$thenews$ItemPage$update, _p7._0, model.itemPage);
	...
	if (typeof _mthadley$thenews$Main$main !== 'undefined') {
	    _mthadley$thenews$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Item.Type":{"args":[],"tags":{"PollOption":[],"Job":[],"Poll":[],"Story":[],"Comment":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"App.Msg":{"args":[],"tags":{"RecieveItems":["Api.Category","Api.Result (List Item.Item)"],"RouteChange":["Router.Route"],"ItemPageMsg":["ItemPage.Msg"]}},"ItemPage.Msg":{"args":[],"tags":{"RecieveItem":["Api.Result Item.Item"],"FetchComments":["Int"],"RouteChange":["Router.Route"],"RecieveComments":["Int","Api.Result (List Item.Item)"]}},"Router.Route":{"args":[],"tags":{"ViewItem":["Int"],"NotFound":[],"View":["Api.Category"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Api.Category":{"args":[],"tags":{"Ask":[],"New":[],"Job":[],"Best":[],"Top":[],"Show":[]}}},"aliases":{"Api.Result":{"args":["a"],"type":"Result.Result Http.Error a"},"Item.PollOpt":{"args":[],"type":"{ by : String , id : Int , parent : Int , score : Int , text : String , time : Int }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Item.Item":{"args":[],"type":"{ by : String , dead : Bool , deleted : Bool , descendants : Maybe.Maybe Int , id : Int , kids : Maybe.Maybe (List Int) , parent : Maybe.Maybe Int , parts : Maybe.Maybe (List Item.PollOpt) , score : Maybe.Maybe Int , text : Maybe.Maybe String , time : Int , title : Maybe.Maybe String , type_ : Item.Type , url : Maybe.Maybe String }"}},"message":"App.Msg"},"versions":{"elm":"0.18.0"}});
	}
